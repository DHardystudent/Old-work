...
function init() {
	...
	// Sky sphere
	var sky = createMesh(new THREE.SphereGeometry(100, 50, 50), "sky.jpg");
	...
	rotar.position.x = 0;
    rotar.position.y = 21;
    rotar.position.z = 5.5;
	scene.add(rotar);
	
	var blade1 = createMesh(new THREE.PlaneGeometry(5, 10, 1, 1), "Blade.png");

	blade1.position.x = 0;
	blade1.position.y = 15.5;
    	blade1.position.z = 8;
    	blade1.rotation.y = 0.3;
	blade1.rotation.z = Math.PI;
	scene.add(blade1);
	
	var blade2 = createMesh(new THREE.PlaneGeometry(5, 10, 1, 1), "Blade.png");
	blade2.position.x = 0;
	blade2.position.y = 26.5;
    	blade2.position.z = 8;
    	blade2.rotation.y = -0.3;
	scene.add(blade2);
	
    var blade3 = createMesh(new THREE.PlaneGeometry(5, 10, 1, 1), "Blade.png");
	blade3.position.x = 5.5;
	blade3.position.y = 21;
   	blade3.position.z = 8;
   	blade3.rotation.x = -0.3;
	blade3.rotation.z = 3*Math.PI/2;
	scene.add(blade3);
	
	var blade4 = createMesh(new THREE.PlaneGeometry(5, 10, 1, 1), "Blade.png");
	blade4.position.x = -5.5;
	blade4.position.y = 21;
    	blade4.position.z = 8;
    	blade4.rotation.x = 0.3;
	...
	var gui = new dat.GUI();
    	gui.add(controls, 'rotationSpeed', 0.0001, 1);
