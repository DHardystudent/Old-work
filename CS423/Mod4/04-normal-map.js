...
// once everything is loadded, we run our Three.js stuff
    function init() {
        ...
        var floorTex = THREE.ImageUtils.loadTexture("../assets/textures/floor-wood.jpg");
...
//        var polyhedron = createMesh(new THREE.PolyhedronGeometry(vertices, faces, controls.radius, controls.detail));
        ...
        var controls = new function () {
            ...
            this.changeTexture = function (e) {
                var texture = THREE.ImageUtils.loadTexture("../assets/textures/" + e + ".jpg");
                sphere2.material.map = texture;
                sphere1.material.map = texture;

                var bump = THREE.ImageUtils.loadTexture("../assets/textures/" + e + "-normal.jpg");
        ...
        function createMesh(geom, imageFile, normal) {
            ...
            if (normal) {
                var t = THREE.ImageUtils.loadTexture("../assets/textures/" + imageFile);
                var m = THREE.ImageUtils.loadTexture("../assets/textures/" + normal);
